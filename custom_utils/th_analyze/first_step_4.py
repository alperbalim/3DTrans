...
mAPbbox, mAPbev, mAP3d, mAPaos, mAPbbox_R40, mAPbev_R40, mAP3d_R40, mAPaos_R40 = do_eval(
    gt_annos, dt_annos_raw, class_ids_to_eval, min_overlaps_for_map, compute_aos=False) # [13]
...
c_idx = 0 # Car indeksi
d_idx = 0 # Tek zorluk kovası indeksi
...
confidence_thresholds_to_analyze = np.arange(0.1, 0.3, 0.5, 0.7, 0.9) # Analiz edilecek güven skoru eşikleri # [16]

# eval_class için sınıf ve zorluk seviyesini seç (tek sınıf, tek zorluk kovası) # [16]
analysis_class_id = 0 # Araba
analysis_difficulty_id = 0 # Tek zorluk kovası
...
for current_iou_for_analysis in iou_thresholds_for_confidence_analysis: # [17]
    ...
    eval_confidence_points = res_eval_class['thresholds'][0, 0, 0, :] # Güven skorları (azalan sırada) # [20]
