...
class CustomDataset(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        def kitti_eval(eval_det_annos, eval_gt_annos, map_name_to_kitti):
            ...
            print("eval_det_annos:",len(eval_det_annos))
            print("eval_gt_annos:",len(eval_gt_annos))
    ...
    def get_infos(self, num_workers=16, has_label=True, count_inside_pts=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            if has_label:
                ...
                temp_loc = annotations['location'].copy()
                ...
                #annotations['location'][:,0:1] = -temp_loc[:,1:2] 
                #annotations['location'][:,1:2] = temp_loc[:,2:3] 
                #annotations['location'][:,2:3] = temp_loc[:,0:1] 
                ...
                gt_boxes_lidar = np.concatenate([loc_lidar, l, w, h, rots[..., np.newaxis]], axis=1) # 2-dimension array
...
def create_custom_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    custom_infos_test = dataset.get_infos(num_workers=workers, has_label=True, count_inside_pts=True)
...
if __name__=='__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        if sys.argv.__len__() > 2:
            ...
            data_name = 'custom_kitti'
        
        create_custom_infos(
            dataset_cfg=dataset_cfg,
            class_names=['Car', 'Pedestrian', 'Cyclist'],
            data_path=ROOT_DIR / 'data' / data_name,
            save_path=ROOT_DIR / 'data' / data_name
        )